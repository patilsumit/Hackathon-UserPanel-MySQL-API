			...
			<div class="col-md-8 col-md-offset-2">
				...
				<!--	<h2 style="font-size: 25px; line-height: 1;">You have downloaded free version of Bingo.</h2>
                    ...
                    <form class="form-horizontal" action="/action_page.php">
						...
						<div class="form-group">
						  <label class="control-label col-sm-3" for="cnumber">Conatact Number:</label>
						  <div class="col-sm-8">          
							<input type="text" class="form-control" id="cnumber" placeholder="Enter Contact Number" name="cnumber">
						  </div>
						</div>
						<div class="form-group">
						  <label class="control-label col-sm-3" for="gname">Guardian Name:</label>
						  <div class="col-sm-8">          
							<input type="text" class="form-control" id="gname" placeholder="Enter Guardian Name" name="gname">
						  </div>
						</div>
						<div class="form-group">
						  <label class="control-label col-sm-3" for="gnumber">Guardian Number:</label>
						  <div class="col-sm-8">          
							<input type="text" class="form-control" id="gnumber" placeholder="Enter Contact Number" name="gnumber">
						  </div>
						</div>
