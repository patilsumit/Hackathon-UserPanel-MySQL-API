		...
		<div class="container">
			<div class="row">
				...
				<div class="contact-details col-md-6 ">
					...
					<p>Instance Women Safety</p>
					<ul class="contact-short-info">
						<li>
							<i class="tf-ion-ios-home"></i>
							<span>GIDC Degree ENgineering College, Abrama, Navsari, Gujarat, India</span>
						</li>
						<li>
							<i class="tf-ion-android-phone-portrait"></i>
							<span>Phone: +919099073865</span>
						</li>
						<li>
						...
						<li>
							...
							<span>Email: IWSafehelper@iwsafe.com</span>
						</li>
					</ul>
					<!-- Footer Social Links -->
            ...
            ?>
				...
				<div class="contact-form col-md-6 ">
					<form id="contact-form" method="post" action="insertcontact.php" role="form">
					
						<div class="form-group">
							<input placeholder="Your Name" class="form-control" name="name" id="name" type="text">
						</div>
						
						<div class="form-group">
							<input placeholder="Your Email" class="form-control" name="email" id="email" type="email">
						</div>
						
						<div class="form-group">
							<input placeholder="Subject" class="form-control" name="subject" id="subject" type="text">
						</div>
						...
						<div id="cf-submit">
							<input id="contact-submit" class="btn btn-transparent" value="Submit" type="submit">
						</div>						
				...
				<div class="contact-form col-md-6 ">
				 <form class="form-horizontal" action="insertcontact.php" method="POST">
						...
						<div class="form-group">        
						      	<button type="submit" class="col-sm-11 btn btn-info" style="margin-left:25px">Submit</button>
              			</div>
