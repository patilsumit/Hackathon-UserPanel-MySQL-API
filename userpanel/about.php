...
<section class="company-mission section-sm bg-gray">
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<h3>Our Mission</h3>
				<p>Our mission is to provide an application that helps to women in distressed condition to send her location and seek help.Whenever a women feel victimised she just have to press one button the application that send the GPS cordinates to the resue team without any verbal description.Moreover we also need to provide solution for the non smart phone users.
				</p>
				<img src="images/company/company-image-2.jpg" alt="" class="img-responsive mt-30">
			</div>
			<div class="col-md-6">
				<h3>Our Vision</h3>
				<p>                                    Our vision is to evolve India as a Safe India.Women are one of most important resource of a nation and to ensure their safety is our prior job .Therefore whenever a women feels that she is not feeling safe or in a distressed situation than such a support should be available that she can depend on for seeking help without any other interfearence of society rather directly an authorised assocciation.                                                                                                                                                                                                        </p>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 text-center">
				<h2>"Because I’m the mother that’s why , I wish with all my might to be treated right"</h2>
			</div>
		</div> 		<!-- End row -->
	</div>   	<!-- End container -->
</section>
				...
				<div class="col-md-4 col-sm-6 ">
	               <div class="team-member text-center">
						...
						<div class="member-content">
							<h3>Er. Brijesh Patel</h3>
							<span>Chief Managing Officer</span>
...
<!-- team member -->
				...
				<!-- team member -->
				<div class="col-md-4 col-sm-6 ">
	               <div class="team-member text-center" style="margin-top: 50px;">
						<div class="member-photo">
							<!-- member photo -->
							<img class="img-responsive" src="images/team/member-2.jpg" alt="Meghna">
							<!-- /member photo -->
